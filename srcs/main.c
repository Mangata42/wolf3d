...
{
	env->chaingun[1].img = mlx_xpm_file_to_image(env->mlx,
		"./textures/chaingun/0.xpm",
		&(env->chaingun[1].width), &(env->chaingun[1].height));
	env->chaingun[2].img = mlx_xpm_file_to_image(env->mlx,
		"./textures/chaingun/1.xpm",
		&(env->chaingun[2].width), &(env->chaingun[2].height));
	env->chaingun[3].img = mlx_xpm_file_to_image(env->mlx,
		"./textures/chaingun/2.xpm",
		&(env->chaingun[3].width), &(env->chaingun[3].height));
	env->chaingun[4].img = mlx_xpm_file_to_image(env->mlx,
		"./textures/chaingun/3.xpm",
		&(env->chaingun[4].width), &(env->chaingun[4].height));
	env->chaingun[5].img = mlx_xpm_file_to_image(env->mlx,
		"./textures/chaingun/4.xpm",
		&(env->chaingun[5].width), &(env->chaingun[5].height));
	env->chaingun[6].img = mlx_xpm_file_to_image(env->mlx,
		"./textures/chaingun/5.xpm",
		&(env->chaingun[6].width), &(env->chaingun[6].height));
	env->chaingun[7].img = mlx_xpm_file_to_image(env->mlx,
		"./textures/chaingun/6.xpm",
...
void	load_textures(t_env *env)
{
	...
	env->chaingun[0].img = mlx_xpm_file_to_image(env->mlx,
		"./textures/chaingun/12.xpm",
